    ...
    <table class="table table-bordered table-striped table-hover">
        ...
        foreach ($this->cart->contents() as $items) : ?>
            <tr>
                ...
                <!-- <td width="10%" onclick="return confirm('yakin ingin menghapus keranjang?')"> <?php echo anchor
                ('dashboard/hapus_item_keranjang' . $items['rowid'], '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td> -->
            </tr>
